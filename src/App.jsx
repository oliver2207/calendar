...
function App() {
  ...
  return (
    <>
      <div class="lg:flex lg:h-full lg:flex-col w-[ ]">
    ...
    <div class="flex items-center">
      ...
      <div class="hidden md:ml-4 md:flex md:items-center">
        <div class="relative">
          ...
          <div class="absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
      ...
      <div class="relative ml-6 md:hidden">
        ...
        <div class="absolute right-0 z-10 mt-3 w-36 origin-top-right divide-y divide-gray-100 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-0-button" tabindex="-1">
          <div class="py-1" role="none">
  ...
  <div class="shadow ring-1 ring-black/5 lg:flex lg:flex-auto lg:flex-col">
    ...
    <div class="flex bg-gray-200 text-xs/6 text-gray-700 lg:flex-auto">
      <div class="hidden w-full lg:grid lg:grid-cols-7 lg:grid-rows-6 lg:gap-px">
        ...
        <div class="relative bg-white px-3 py-2">
          <time datetime="2022-01-12" class="flex size-6 items-center justify-center rounded-full bg-indigo-600 font-semibold text-white">12</time>
          <ol class="mt-2">
            <li>
              <a href="#" class="group flex">
